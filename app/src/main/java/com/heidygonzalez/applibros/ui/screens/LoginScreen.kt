...
fun LoginScreen(navController: NavController, loginViewModel: LoginViewModel) {
    ...
    Column(
        ...
        Text(
            text = "Lyrica Books",
            style = TextStyle(
                color = MaterialTheme.colorScheme.onBackground, // Se adapta al tema (negro/blanco)
                fontSize = 40.sp, // Tamaño grande para destacar
                fontWeight = FontWeight.ExtraBold, // Para hacerlo más llamativo
                fontFamily = FontFamily.Cursive // Tipo de letra estético (puedes cambiarlo según gusto)
            ),
            textAlign = TextAlign.Center,
            modifier = Modifier
                .fillMaxWidth()
                .padding(bottom = 32.dp) // Espaciado para separar el título del contenido
        )
